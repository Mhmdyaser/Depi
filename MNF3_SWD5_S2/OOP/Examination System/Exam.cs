...
namespace Examination_System
{
    internal class Exam
    {
        ...
        public void AddQuestion(Question question)
        {
            ...
            {
                Console.WriteLine("Cannot add question. Total marks exceed course maximum degree.");
                return;
            }
        ...
        public int GradeExam(Student student)
        {
            ...
            Console.WriteLine($"\nExam Finished. Final Score = {score}/{_course.MaxDegree}");
