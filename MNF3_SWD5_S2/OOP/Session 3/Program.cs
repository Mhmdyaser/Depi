...
namespace Bank_account
{
    ...
    public class SavingAccount : BankAcount
    {
        ...
        public SavingAccount(int accountNumber, string fullName, long nationalID, string phoneNumber, string address, double balance, decimal interestRate)
        ...
        {
            return (Convert.ToDecimal (Balance) * InterestRate / 100);
        }
    ...
    public class CurrentAccount: BankAcount
    {
        ...
        public CurrentAccount(int accountNumber, string fullName, long nationalID, string phoneNumber, string address, double balance, decimal overdraftLimit)
            : base(accountNumber, fullName, nationalID, phoneNumber, address, balance)
        {
    ...
    internal class Program
    {
        ...
        {
            SavingAccount SA = new SavingAccount(1, "Mohamed Yaser", 12345678901234, "01012345678", "Cairo", 1000, 5);
          
            CurrentAccount CA = new CurrentAccount(2, "Ahmed Ali", 23456789012345, "01023456789", "Giza", 2000, 1000);

            List<BankAcount> accounts = new List<BankAcount>();
            accounts.Add(SA);
            accounts.Add(CA);

            foreach (BankAcount account in accounts)
            {
